...
module rro(selec_phase, \input , Result);
  ...
  input selec_phase;
  wire selec_phase;
  assign rtil_signal_02_ = \input  == 32'd4286578688;
  assign rtil_signal_03_ = rtil_signal_02_ ? 32'd4160749568 : rtil_signal_07_;
  assign rtil_signal_04_ = \input [30:23] == 8'hff;
  assign rtil_signal_05_ = | \input [22:0];
  assign rtil_signal_06_ = rtil_signal_05_ & rtil_signal_04_;
  assign rtil_signal_07_ = rtil_signal_06_ ? { 9'h1ff, \input [22:0] } : rtil_signal_10_;
  assign rtil_signal_08_ = ~ \input [31];
  ...
  assign rtil_signal_11_ = \input [31] & s_too_big_exponent;
  assign rtil_signal_12_ = rtil_signal_11_ ? 32'd4160749568 : rtil_signal_16_;
  assign rtil_signal_13_ = ! \input ;
  assign rtil_signal_14_ = ! \input [30:23];
  ...
  assign ieee_out_sin_cos = rtil_signal_04_ ? \input  : { \input [31], rro_trig_qua, 5'h00, rro_trig_fixed_point };
  assign rtil_signal_17_ = \input [30:23] > 8'h85;
  assign s_too_big_exponent = rtil_signal_17_ ? 1'h1 : 1'h0;
  assign s_exp2_shift = 8'h85 - \input [30:23];
  assign s_exp2_fixed_point = { 3'h1, \input [22:0], 6'h00 } >> { 24'h000000, s_exp2_shift };
  assign s_exp2_cmp = s_exp2_fixed_point ^ { \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31], \input [31] };
  assign rtil_signal_00_ = s_exp2_cmp + 32'd1;
  assign s_exp2_adjs = \input [31] ? rtil_signal_00_ : s_exp2_cmp;
  assign rtil_signal_01_ = \input  == 32'd2139095040;
