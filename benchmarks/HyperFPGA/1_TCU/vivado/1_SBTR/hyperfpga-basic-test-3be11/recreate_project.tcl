...
#
# Generated by Vivado on Wed May 14 18:19:21 CEST 2025
...
#    "./sbtr/fpadd_3_pipe_gate_sbtr.v"
#    "./sbtr/shift_register.v"
#    "./sbtr/super_sabouter.v"
#    "./sbtr/sub_tensor_core_fi_sbtr.v"
#    "./sbtr/output_buffer.v"
#    "./sbtr/Input_buffer.v"
#    "./sbtr/FSM_controller.v"
#    "./sbtr/clock_div.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/sbtr/fpadd_3_pipe_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/shift_register.v"]"\
 "[file normalize "$origin_dir/sbtr/super_sabouter.v"]"\
 "[file normalize "$origin_dir/sbtr/sub_tensor_core_fi_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/output_buffer.v"]"\
 "[file normalize "$origin_dir/sbtr/Input_buffer.v"]"\
 "[file normalize "$origin_dir/sbtr/FSM_controller.v"]"\
...
set file "$origin_dir/sbtr/fpadd_3_pipe_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/sub_tensor_core_fi_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/output_buffer.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/Input_buffer.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/FSM_controller.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files fpadd_3_pipe_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/fpadd_3_pipe_gate_sbtr.v
}
...
if { [get_files sub_tensor_core_fi_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/sub_tensor_core_fi_sbtr.v
}
if { [get_files output_buffer.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/output_buffer.v
}
if { [get_files Input_buffer.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/Input_buffer.v
}
if { [get_files Input_buffer.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/Input_buffer.v
}
if { [get_files FSM_controller.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/FSM_controller.v
}
...
# module references:
# FSM_controller, input_buffer, output_buffer, pipe_1_register, sub_tensor_core
  ...
  set block_name FSM_controller
  set block_cell_name FSM_controller_0
  if { [catch {set FSM_controller_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $FSM_controller_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
    CONFIG.DEPTH_INPUT {47} \
    CONFIG.DEPTH_OUTPUT {15} \
    CONFIG.FREQ_DIV {1} \
  ] $FSM_controller_0
  ...
  # Create instance: input_buffer_0, and set properties
  set block_name input_buffer
  set block_cell_name input_buffer_0
  if { [catch {set input_buffer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $input_buffer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: pipe_1_register_0, and set properties
  set block_name pipe_1_register
  set block_cell_name pipe_1_register_0
  if { [catch {set pipe_1_register_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pipe_1_register_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: sub_tensor_core_0, and set properties
  set block_name sub_tensor_core
  set block_cell_name sub_tensor_core_0
  if { [catch {set sub_tensor_core_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $sub_tensor_core_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [list \
    CONFIG.IN0_WIDTH {128} \
    CONFIG.IN1_WIDTH {128} \
    CONFIG.IN2_WIDTH {128} \
    CONFIG.IN3_WIDTH {128} \
    CONFIG.NUM_PORTS {4} \
  ] $xlconcat_0
...
\
  ...
  connect_bd_net -net FSM_controller_0_clk2 [get_bd_pins FSM_controller_0/clk2] [get_bd_pins sub_tensor_core_0/clk]
  connect_bd_net -net FSM_controller_0_load_input [get_bd_pins FSM_controller_0/load_input] [get_bd_pins pipe_1_register_0/enable]
  connect_bd_net -net FSM_controller_0_load_result [get_bd_pins FSM_controller_0/load_result] [get_bd_pins output_buffer_0/load]
  connect_bd_net -net FSM_controller_0_re_i [get_bd_pins FSM_controller_0/re_i] [get_bd_pins comblock_0/fifo_re_i]
  connect_bd_net -net FSM_controller_0_we [get_bd_pins FSM_controller_0/we] [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins output_buffer_0/shift]
  ...
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins comblock_0/fifo_data_o] [get_bd_pins input_buffer_0/data_in]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins FSM_controller_0/val_input] [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins input_buffer_0/enable]
  ...
  connect_bd_net -net input_buffer_0_data_out [get_bd_pins input_buffer_0/data_out] [get_bd_pins pipe_1_register_0/data_in]
  connect_bd_net -net output_buffer_0_output_data [get_bd_pins comblock_0/fifo_data_i] [get_bd_pins output_buffer_0/output_data]
  connect_bd_net -net pipe_1_register_0_data_out [get_bd_pins pipe_1_register_0/data_out] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_10/Din] [get_bd_pins xlslice_11/Din] [get_bd_pins xlslice_12/Din] [get_bd_pins xlslice_13/Din] [get_bd_pins xlslice_14/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_6/Din] [get_bd_pins xlslice_7/Din] [get_bd_pins xlslice_8/Din] [get_bd_pins xlslice_9/Din]
  ...
  connect_bd_net -net sub_tensor_core_0_W_0X3 [get_bd_pins sub_tensor_core_0/W_0X3] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net sub_tensor_core_0_W_1X3 [get_bd_pins sub_tensor_core_0/W_1X3] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net sub_tensor_core_0_W_2X3 [get_bd_pins sub_tensor_core_0/W_2X3] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net sub_tensor_core_0_W_3X3 [get_bd_pins sub_tensor_core_0/W_3X3] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net sub_tensor_core_0_o_SI [get_bd_pins sub_tensor_core_0/o_SI] [get_bd_pins xlconcat_3/In0]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins FSM_controller_0/rst] [get_bd_pins input_buffer_0/rst] [get_bd_pins output_buffer_0/rst] [get_bd_pins pipe_1_register_0/rst] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins comblock_0/fifo_clear_i] [get_bd_pins sub_tensor_core_0/rst] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net wen_const_1_dout [get_bd_pins comblock_0/ram_we_i] [get_bd_pins wen_const_1/dout]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins output_buffer_0/input_data] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins sub_tensor_core_0/i_FI_CONTROL_PORT] [get_bd_pins xlconcat_2/dout]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins sub_tensor_core_0/A_0X] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_10_Dout [get_bd_pins sub_tensor_core_0/B_3X] [get_bd_pins xlslice_10/Dout]
  connect_bd_net -net xlslice_11_Dout [get_bd_pins sub_tensor_core_0/C_0X] [get_bd_pins xlslice_11/Dout]
  connect_bd_net -net xlslice_12_Dout [get_bd_pins sub_tensor_core_0/C_1X] [get_bd_pins xlslice_12/Dout]
  connect_bd_net -net xlslice_13_Dout [get_bd_pins sub_tensor_core_0/C_2X] [get_bd_pins xlslice_13/Dout]
  connect_bd_net -net xlslice_14_Dout [get_bd_pins sub_tensor_core_0/C_3X] [get_bd_pins xlslice_14/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins sub_tensor_core_0/A_1X] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins sub_tensor_core_0/A_2X] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins xlconcat_2/In0] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins sub_tensor_core_0/i_SI] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins xlconcat_2/In1] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_pins sub_tensor_core_0/A_3X] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins sub_tensor_core_0/B_0X] [get_bd_pins xlslice_7/Dout]
  connect_bd_net -net xlslice_8_Dout [get_bd_pins sub_tensor_core_0/B_1X] [get_bd_pins xlslice_8/Dout]
  connect_bd_net -net xlslice_9_Dout [get_bd_pins sub_tensor_core_0/B_2X] [get_bd_pins xlslice_9/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins FSM_controller_0/clk] [get_bd_pins axi_smc/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins comblock_0/axif_aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins comblock_0/ram_clk_i] [get_bd_pins comblock_1/axil_aclk] [get_bd_pins input_buffer_0/clk] [get_bd_pins output_buffer_0/clk] [get_bd_pins pipe_1_register_0/clk] [get_bd_pins rst_ps8_0_187M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
