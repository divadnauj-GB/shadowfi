...
#
# Generated by Vivado on Wed May 14 18:20:16 CEST 2025
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/sbtr/TCU_buffer.v"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "$origin_dir/sbtr/TCU_buffer.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# module references:
# FSM_controller, clock_div, input_buffer, output_buffer, sub_tensor_core
...
\
  ...
  connect_bd_net -net FSM_controller_0_shift_out [get_bd_pins FSM_controller_0/shift_out] [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins output_buffer_0/shift]
  ...
  connect_bd_net -net clock_div_0_clk_out [get_bd_pins clock_div_0/clk_out] [get_bd_pins sub_tensor_core_0/clk]
  ...
  connect_bd_net -net input_buffer_0_data_out [get_bd_pins input_buffer_0/data_out] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_10/Din] [get_bd_pins xlslice_11/Din] [get_bd_pins xlslice_12/Din] [get_bd_pins xlslice_13/Din] [get_bd_pins xlslice_14/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_6/Din] [get_bd_pins xlslice_7/Din] [get_bd_pins xlslice_8/Din] [get_bd_pins xlslice_9/Din]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins FSM_controller_0/rst] [get_bd_pins clock_div_0/rst] [get_bd_pins input_buffer_0/rst] [get_bd_pins output_buffer_0/rst] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
