...
#
# Generated by Vivado on Wed May 14 18:21:06 CEST 2025
...
set file "$origin_dir/sbtr/TCU_core.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files TCU_buffer.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/TCU_buffer.v
}
...
if { [get_files TCU_core.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/TCU_core.v
}
...
# TCU_buffer, sub_tensor_core
  ...
  # Create instance: TCU_buffer_0, and set properties
  set block_name TCU_buffer
  set block_cell_name TCU_buffer_0
  if { [catch {set TCU_buffer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $TCU_buffer_0 eq "" } {
...
\
  ...
  connect_bd_net -net TCU_buffer_0_TC0_A_0X [get_bd_pins TCU_buffer_0/TC0_A_0X] [get_bd_pins sub_tensor_core_0/A_0X]
  connect_bd_net -net TCU_buffer_0_TC0_A_1X [get_bd_pins TCU_buffer_0/TC0_A_1X] [get_bd_pins sub_tensor_core_0/A_1X]
  connect_bd_net -net TCU_buffer_0_TC0_A_2X [get_bd_pins TCU_buffer_0/TC0_A_2X] [get_bd_pins sub_tensor_core_0/A_2X]
  connect_bd_net -net TCU_buffer_0_TC0_A_3X [get_bd_pins TCU_buffer_0/TC0_A_3X] [get_bd_pins sub_tensor_core_0/A_3X]
  connect_bd_net -net TCU_buffer_0_TC0_B_0X [get_bd_pins TCU_buffer_0/TC0_B_0X] [get_bd_pins sub_tensor_core_0/B_0X]
  connect_bd_net -net TCU_buffer_0_TC0_B_1X [get_bd_pins TCU_buffer_0/TC0_B_1X] [get_bd_pins sub_tensor_core_0/B_1X]
  connect_bd_net -net TCU_buffer_0_TC0_B_2X [get_bd_pins TCU_buffer_0/TC0_B_2X] [get_bd_pins sub_tensor_core_0/B_2X]
  connect_bd_net -net TCU_buffer_0_TC0_B_3X [get_bd_pins TCU_buffer_0/TC0_B_3X] [get_bd_pins sub_tensor_core_0/B_3X]
  connect_bd_net -net TCU_buffer_0_TC0_C_0X [get_bd_pins TCU_buffer_0/TC0_C_0X] [get_bd_pins sub_tensor_core_0/C_0X]
  connect_bd_net -net TCU_buffer_0_TC0_C_1X [get_bd_pins TCU_buffer_0/TC0_C_1X] [get_bd_pins sub_tensor_core_0/C_1X]
  connect_bd_net -net TCU_buffer_0_TC0_C_2X [get_bd_pins TCU_buffer_0/TC0_C_2X] [get_bd_pins sub_tensor_core_0/C_2X]
  connect_bd_net -net TCU_buffer_0_TC0_C_3X [get_bd_pins TCU_buffer_0/TC0_C_3X] [get_bd_pins sub_tensor_core_0/C_3X]
  connect_bd_net -net TCU_buffer_0_TC1_A_1X [get_bd_pins TCU_buffer_0/TC1_A_1X] [get_bd_pins sub_tensor_core_0/i_SI]
  connect_bd_net -net TCU_buffer_0_TCU_D_output [get_bd_pins TCU_buffer_0/TCU_D_output] [get_bd_pins comblock_0/fifo_data_i]
  connect_bd_net -net TCU_buffer_0_TCU_enable [get_bd_pins TCU_buffer_0/TCU_enable] [get_bd_pins TCU_buffer_0/result_valid] [get_bd_pins comblock_0/fifo_we_i]
  connect_bd_net -net c_addsub_0_S [get_bd_pins c_addsub_0/S] [get_bd_pins comblock_0/reg1_i] [get_bd_pins comblock_0/reg2_i] [get_bd_pins comblock_0/reg3_i]
  ...
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins TCU_buffer_0/TCU_ABC_input] [get_bd_pins comblock_0/fifo_data_o]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins TCU_buffer_0/valid_data] [get_bd_pins comblock_0/fifo_valid_o]
  ...
  connect_bd_net -net comblock_0_reg3_o [get_bd_pins comblock_0/reg3_o] [get_bd_pins sub_tensor_core_0/i_FI_CONTROL_PORT]
  ...
  connect_bd_net -net sub_tensor_core_0_W_3X3 [get_bd_pins TCU_buffer_0/TC0_W_3X3] [get_bd_pins sub_tensor_core_0/W_3X3]
  connect_bd_net -net sub_tensor_core_0_o_SI [get_bd_pins TCU_buffer_0/TC1_W_3X3] [get_bd_pins sub_tensor_core_0/o_SI]
  connect_bd_net -net sub_tensor_core_2_32_0_w_0x3 [get_bd_pins TCU_buffer_0/TC0_W_0X3] [get_bd_pins TCU_buffer_0/TC1_W_0X3] [get_bd_pins sub_tensor_core_0/W_0X3]
  connect_bd_net -net sub_tensor_core_2_32_0_w_1x3 [get_bd_pins TCU_buffer_0/TC0_W_1X3] [get_bd_pins TCU_buffer_0/TC1_W_1X3] [get_bd_pins sub_tensor_core_0/W_1X3]
  connect_bd_net -net sub_tensor_core_2_32_0_w_2x3 [get_bd_pins TCU_buffer_0/TC0_W_2X3] [get_bd_pins TCU_buffer_0/TC1_W_2X3] [get_bd_pins sub_tensor_core_0/W_2X3]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins TCU_buffer_0/rst] [get_bd_pins sub_tensor_core_0/rst] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins TCU_buffer_0/clk] [get_bd_pins axi_smc/aclk] [get_bd_pins c_addsub_0/CLK] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins comblock_0/axif_aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins comblock_0/ram_clk_i] [get_bd_pins comblock_1/axil_aclk] [get_bd_pins comblock_1/fifo_clk_i] [get_bd_pins rst_ps8_0_187M/slowest_sync_clk] [get_bd_pins sub_tensor_core_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
