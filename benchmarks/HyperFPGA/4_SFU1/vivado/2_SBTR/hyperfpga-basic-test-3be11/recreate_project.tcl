...
#
# Generated by Vivado on Wed May 14 18:37:47 CEST 2025
...
#    "./sbtr/exp2_luts_64x23b_64_gate_sbtr.v"
#    "./sbtr/log2_luts_64x23b_64_gate_sbtr.v"
#    "./sbtr/shift_register.v"
#    "./sbtr/suma_resta_32_gate_sbtr.v"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/sbtr/exp2_luts_64x23b_64_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/log2_luts_64x23b_64_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/shift_register.v"]"\
 "[file normalize "$origin_dir/sbtr/suma_resta_32_gate_sbtr.v"]"\
...
set file "$origin_dir/sbtr/exp2_luts_64x23b_64_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/log2_luts_64x23b_64_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/suma_resta_32_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files exp2_luts_64x23b_64_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/exp2_luts_64x23b_64_gate_sbtr.v
}
if { [get_files log2_luts_64x23b_64_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/log2_luts_64x23b_64_gate_sbtr.v
}
if { [get_files shift_register.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/shift_register.v
}
if { [get_files suma_resta_32_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/suma_resta_32_gate_sbtr.v
}
