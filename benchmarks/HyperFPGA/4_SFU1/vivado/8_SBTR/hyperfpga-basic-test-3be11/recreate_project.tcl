...
#
# Generated by Vivado on Wed May 14 18:39:14 CEST 2025
...
\
  ...
  connect_bd_net -net comblock_0_reg0_o [get_bd_pins comblock_0/reg0_i] [get_bd_pins comblock_0/reg0_o] [get_bd_pins sfu_controller_0/valid_i] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net comblock_0_reg1_o [get_bd_pins comblock_0/reg1_o] [get_bd_pins sfu_controller_0/selop_i]
  connect_bd_net -net comblock_0_reg2_o [get_bd_pins comblock_0/reg2_o] [get_bd_pins sfu_controller_0/data_i]
  connect_bd_net -net comblock_0_reg3_o [get_bd_pins comblock_0/reg3_o] [get_bd_pins sfu_0/i_FI_CONTROL_PORT]
  connect_bd_net -net comblock_0_reg4_o [get_bd_pins comblock_0/reg4_o] [get_bd_pins util_ff_1/D]
  ...
  connect_bd_net -net sfu_0_stall_o [get_bd_pins sfu_0/stall_o] [get_bd_pins sfu_controller_0/stall_i]
  connect_bd_net -net sfu_controller_0_data_o [get_bd_pins sfu_0/src1_i] [get_bd_pins sfu_controller_0/data_o]
  connect_bd_net -net sfu_controller_0_selop_o [get_bd_pins sfu_0/selop_i] [get_bd_pins sfu_controller_0/selop_o]
  connect_bd_net -net sfu_controller_0_start_o [get_bd_pins sfu_0/start_i] [get_bd_pins sfu_controller_0/start_o]
  connect_bd_net -net util_ff_1_Q [get_bd_pins sfu_0/i_SI] [get_bd_pins util_ff_1/Q]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins sfu_0/rst_n] [get_bd_pins sfu_controller_0/rst] [get_bd_pins util_ff_0/reset] [get_bd_pins util_ff_1/reset] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins util_ff_0/clk_enable] [get_bd_pins util_ff_1/clk_enable] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins comblock_0/axif_aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins comblock_0/ram_clk_i] [get_bd_pins comblock_1/axil_aclk] [get_bd_pins comblock_1/fifo_clk_i] [get_bd_pins rst_ps8_0_187M/slowest_sync_clk] [get_bd_pins sfu_0/clk_i] [get_bd_pins sfu_controller_0/clk] [get_bd_pins util_ff_0/clk] [get_bd_pins util_ff_1/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
