...
#
# Generated by Vivado on Wed May 14 18:34:20 CEST 2025
...
#    "./sbtr/fused_accum_tree_gate_sbtr.v"
#    "./sbtr/rom_29_20_14_4_7_gate_sbtr.v"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/sbtr/fused_accum_tree_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/rom_29_20_14_4_7_gate_sbtr.v"]"\
 ...
 "[file normalize "$origin_dir/sbtr/sfu.v"]"\
...
set file "$origin_dir/sbtr/fused_accum_tree_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/rom_29_20_14_4_7_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/sfu.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files fused_accum_tree_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/fused_accum_tree_gate_sbtr.v
}
if { [get_files rom_29_20_14_4_7_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/rom_29_20_14_4_7_gate_sbtr.v
}
...
if { [get_files sfu.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/sfu.v
}
...
# module references:
# phase_select, rro, sfu, sfu_input_sel
...
\
  ...
  connect_bd_net -net c_addsub_0_S [get_bd_pins comblock_0/reg1_i] [get_bd_pins comblock_0/reg2_i] [get_bd_pins comblock_0/reg3_i] [get_bd_pins util_ff_0/Q]
  ...
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins comblock_0/fifo_data_o] [get_bd_pins rro_0/rro_input] [get_bd_pins sfu_input_sel_0/src_i]
  ...
  connect_bd_net -net comblock_0_reg2_o [get_bd_pins comblock_0/reg2_o] [get_bd_pins phase_select_0/selop_i] [get_bd_pins sfu_0/selop_i] [get_bd_pins sfu_input_sel_0/selop_i]
  connect_bd_net -net comblock_0_reg3_o [get_bd_pins comblock_0/reg3_o] [get_bd_pins util_ff_1/D]
  connect_bd_net -net comblock_0_reg4_o [get_bd_pins comblock_0/reg4_o] [get_bd_pins sfu_0/i_FI_CONTROL_PORT]
  ...
  connect_bd_net -net sfu_0_o_SI [get_bd_pins sfu_0/o_SI] [get_bd_pins util_ff_0/D]
  connect_bd_net -net sfu_input_sel_0_sfu_input [get_bd_pins sfu_0/src1_i] [get_bd_pins sfu_input_sel_0/sfu_input]
  connect_bd_net -net util_ff_1_Q [get_bd_pins sfu_0/i_SI] [get_bd_pins util_ff_1/Q]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_ff_0/reset] [get_bd_pins util_ff_1/reset] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins util_ff_0/clk_enable] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins util_ff_1/clk_enable] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins comblock_0/axif_aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins comblock_0/ram_clk_i] [get_bd_pins comblock_1/axil_aclk] [get_bd_pins comblock_1/fifo_clk_i] [get_bd_pins rst_ps8_0_187M/slowest_sync_clk] [get_bd_pins util_ff_0/clk] [get_bd_pins util_ff_1/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
