...
################################################################
# This is a generated script based on design: basic_test_2_3be11
#
...
# source basic_test_2_3be11_script.tcl
...
\
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins comblock_1/AXIF]
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins axi_smc/M03_AXI] [get_bd_intf_pins comblock_1/AXIL]
  ...
  connect_bd_net -net comblock_1_fifo_data_o [get_bd_pins comblock_1/fifo_data_i] [get_bd_pins comblock_1/fifo_data_o]
  connect_bd_net -net comblock_1_fifo_valid_o [get_bd_pins comblock_1/fifo_valid_o] [get_bd_pins comblock_1/fifo_we_i]
  connect_bd_net -net comblock_1_reg0_o [get_bd_pins comblock_1/reg0_i] [get_bd_pins comblock_1/reg0_o]
  connect_bd_net -net rst_ps8_0_187M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins comblock_0/axif_aresetn] [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins comblock_1/axif_aresetn] [get_bd_pins comblock_1/axil_aresetn] [get_bd_pins rst_ps8_0_187M/peripheral_aresetn]
  connect_bd_net -net wen_const_1_dout [get_bd_pins comblock_0/fifo_re_i] [get_bd_pins comblock_0/ram_we_i] [get_bd_pins comblock_1/fifo_re_i] [get_bd_pins wen_const_1/dout]
  ...
  assign_bd_address -offset 0x80080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs comblock_1/AXIF/AXIF] -force
  assign_bd_address -offset 0x80050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs comblock_1/AXIL/AXIL] -force
