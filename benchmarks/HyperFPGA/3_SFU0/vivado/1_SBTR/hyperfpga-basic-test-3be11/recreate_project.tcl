...
#
# Generated by Vivado on Wed May 14 18:31:56 CEST 2025
...
#    "./sbtr/sfu_exceptions_gate_sbtr.v"
#    "./sbtr/shift_register.v"
#    "./sbtr/squaring_17_gate_sbtr.v"
#    "./sbtr/super_sabouter.v"
#    "./sbtr/sfu_fi_sbtr.v"
#    "./sbtr/rro.v"
#    "./sbtr/sfu_input_sel.v"
#    "./sbtr/phase_select.v"
#    "./sbtr/clock_div.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/sbtr/sfu_exceptions_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/shift_register.v"]"\
 "[file normalize "$origin_dir/sbtr/squaring_17_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/super_sabouter.v"]"\
 "[file normalize "$origin_dir/sbtr/sfu_fi_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/rro.v"]"\
 "[file normalize "$origin_dir/sbtr/sfu_input_sel.v"]"\
 "[file normalize "$origin_dir/sbtr/phase_select.v"]"\
...
set file "$origin_dir/sbtr/sfu_exceptions_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/squaring_17_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/rro.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/sfu_input_sel.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/phase_select.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files sfu_exceptions_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/sfu_exceptions_gate_sbtr.v
}
if { [get_files shift_register.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/shift_register.v
}
if { [get_files squaring_17_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/squaring_17_gate_sbtr.v
}
...
if { [get_files rro.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/rro.v
}
if { [get_files sfu_input_sel.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/sfu_input_sel.v
}
if { [get_files phase_select.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/phase_select.v
}
...
# module references:
# clock_div, phase_select, rro, sfu, sfu_input_sel
  ...
  # Create instance: phase_select_0, and set properties
  set block_name phase_select
  set block_cell_name phase_select_0
  if { [catch {set phase_select_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $phase_select_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rro_0, and set properties
  set block_name rro
  set block_cell_name rro_0
  if { [catch {set rro_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rro_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: sfu_input_sel_0, and set properties
  set block_name sfu_input_sel
  set block_cell_name sfu_input_sel_0
  if { [catch {set sfu_input_sel_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $sfu_input_sel_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
\
  ...
  connect_bd_net -net clock_div_0_clk_out [get_bd_pins clock_div_0/clk_out] [get_bd_pins comblock_0/fifo_re_i] [get_bd_pins util_ff_0/D]
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins comblock_0/fifo_data_o] [get_bd_pins util_ff_2/D]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins util_ff_1/D] [get_bd_pins util_ff_2/clk_enable] [get_bd_pins util_ff_3/clk_enable]
  ...
  connect_bd_net -net phase_select_0_selec_phase_o [get_bd_pins phase_select_0/selec_phase_o] [get_bd_pins rro_0/selec_phase]
  connect_bd_net -net rro_0_Result [get_bd_pins rro_0/Result] [get_bd_pins sfu_input_sel_0/rro_input]
  ...
  connect_bd_net -net sfu_input_sel_0_sfu_input [get_bd_pins sfu_0/src1_i] [get_bd_pins sfu_input_sel_0/sfu_input]
  connect_bd_net -net util_ff_0_Q [get_bd_pins util_ff_0/Q] [get_bd_pins util_ff_1/clk_enable] [get_bd_pins util_vector_logic_2/Op2]
  connect_bd_net -net util_ff_1_Q [get_bd_pins util_ff_1/Q] [get_bd_pins util_vector_logic_2/Op1]
  connect_bd_net -net util_ff_2_Q [get_bd_pins rro_0/rro_input] [get_bd_pins sfu_input_sel_0/src_i] [get_bd_pins util_ff_2/Q]
  connect_bd_net -net util_ff_3_Q [get_bd_pins phase_select_0/selop_i] [get_bd_pins sfu_0/selop_i] [get_bd_pins sfu_input_sel_0/selop_i] [get_bd_pins util_ff_3/Q]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins clock_div_0/rst] [get_bd_pins util_ff_0/reset] [get_bd_pins util_ff_1/reset] [get_bd_pins util_ff_2/reset] [get_bd_pins util_ff_3/reset] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins comblock_0/fifo_clear_i] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins util_vector_logic_2/Res]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clock_div_0/clk] [get_bd_pins comblock_0/axif_aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins comblock_0/ram_clk_i] [get_bd_pins comblock_1/axil_aclk] [get_bd_pins rst_ps8_0_187M/slowest_sync_clk] [get_bd_pins util_ff_0/clk] [get_bd_pins util_ff_1/clk] [get_bd_pins util_ff_2/clk] [get_bd_pins util_ff_3/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
