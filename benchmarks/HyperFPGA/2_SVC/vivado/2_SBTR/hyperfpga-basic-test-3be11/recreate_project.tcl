...
#
# Generated by Vivado on Wed May 14 18:27:33 CEST 2025
...
\
  ...
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins comblock_0/fifo_data_o] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins util_vector_logic_2/Op1]
  ...
  connect_bd_net -net stereo_match_0_o_SI [get_bd_pins stereo_match_0/o_SI] [get_bd_pins xlconcat_3/In0]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins stereo_match_0/i_rstn] [get_bd_pins util_ff_0/reset] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins comblock_0/fifo_clear_i] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins stereo_match_0/i_dval] [get_bd_pins util_vector_logic_2/Res]
  ...
  connect_bd_net -net xlconcat_2_dout [get_bd_pins stereo_match_0/i_FI_CONTROL_PORT] [get_bd_pins xlconcat_2/dout]
  ...
  connect_bd_net -net xlslice_2_Dout [get_bd_pins util_vector_logic_2/Op2] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins xlconcat_2/In0] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins stereo_match_0/i_SI] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins xlconcat_2/In1] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins comblock_0/axif_aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins comblock_0/ram_clk_i] [get_bd_pins comblock_1/axil_aclk] [get_bd_pins rst_ps8_0_187M/slowest_sync_clk] [get_bd_pins stereo_match_0/i_clk] [get_bd_pins util_ff_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
