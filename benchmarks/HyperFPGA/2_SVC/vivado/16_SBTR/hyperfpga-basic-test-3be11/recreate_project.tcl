...
#
# Generated by Vivado on Wed May 14 18:30:11 CEST 2025
...
#    "./sbtr/disp_cmp_13_64_7_gate_sbtr.v"
#    "./sbtr/shift_register.v"
#    "./sbtr/super_sabouter.v"
#    "./sbtr/window_sum_13_450_7_gate_sbtr.v"
#    "./sbtr/stereo_match.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/sbtr/disp_cmp_13_64_7_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/shift_register.v"]"\
 "[file normalize "$origin_dir/sbtr/super_sabouter.v"]"\
 "[file normalize "$origin_dir/sbtr/window_sum_13_450_7_gate_sbtr.v"]"\
 "[file normalize "$origin_dir/sbtr/stereo_match.v"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "$origin_dir/sbtr/disp_cmp_13_64_7_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/window_sum_13_450_7_gate_sbtr.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/sbtr/stereo_match.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files disp_cmp_13_64_7_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/disp_cmp_13_64_7_gate_sbtr.v
}
...
if { [get_files window_sum_13_450_7_gate_sbtr.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/window_sum_13_450_7_gate_sbtr.v
}
if { [get_files stereo_match.v] == "" } {
  import_files -quiet -fileset sources_1 ./sbtr/stereo_match.v
}
...
proc create_hier_cell_Multiplier_32_bit { parentCell nameHier } {
  ...
  # Create instance: stereo_match_0, and set properties
  set block_name stereo_match
  set block_cell_name stereo_match_0
  if { [catch {set stereo_match_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $stereo_match_0 eq "" } {
  ...
  set_property CONFIG.C_WIDTH {32} $util_ff_0
  ...
  set_property CONFIG.C_FF_TYPE {1} $util_ff_1
...
\
  ...
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins stereo_match_0/i_dval]
  ...
  connect_bd_net -net comblock_0_reg2_o [get_bd_pins comblock_0/reg2_o] [get_bd_pins stereo_match_0/i_FI_CONTROL_PORT]
  connect_bd_net -net comblock_0_reg3_o [get_bd_pins Multiplier_32_bit/A] [get_bd_pins comblock_0/reg3_o]
  connect_bd_net -net comblock_0_reg4_o [get_bd_pins Multiplier_32_bit/B] [get_bd_pins comblock_0/reg4_o] [get_bd_pins stereo_match_0/i_SI]
  ...
  connect_bd_net -net stereo_match_0_o_SI [get_bd_pins stereo_match_0/o_SI] [get_bd_pins util_ff_1/D]
  connect_bd_net -net stereo_match_0_o_data [get_bd_pins stereo_match_0/o_data] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net stereo_match_0_o_dval [get_bd_pins stereo_match_0/o_dval] [get_bd_pins util_ff_0/clk_enable] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net util_ff_0_Q [get_bd_pins comblock_0/fifo_data_i] [get_bd_pins util_ff_0/Q]
  connect_bd_net -net util_ff_1_Q [get_bd_pins comblock_0/reg1_i] [get_bd_pins util_ff_1/Q]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins stereo_match_0/i_rstn] [get_bd_pins util_ff_0/reset] [get_bd_pins util_ff_1/reset] [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins util_ff_0/D] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins stereo_match_0/i_thresh_lrcc] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins util_ff_1/clk_enable] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins stereo_match_0/i_data_r] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins stereo_match_0/i_data_l] [get_bd_pins xlslice_1/Dout]
