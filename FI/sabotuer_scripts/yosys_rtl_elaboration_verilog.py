...
def yosys_rtl_elaboration(
    ...
    for param in PARAMS:
        yosys_script.append(f"chparam -set {param[0]} {param[1]} {TOP_MODULE}\n")            
    ...
    yosys_script.append(f"write_verilog -simple-lhs -noattr -attr2comment -renameprefix rttil_signal {os.path.abspath(OUT_DIR)}/{FILE_OUT_NAME}\n")
